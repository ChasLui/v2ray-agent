...
- [Cloudflare Optimization Solution](https://github.com/chaslui/v2ray-agent/blob/master/documents/optimize_V2Ray.md)
- [Traffic Relay](https://github.com/chaslui/v2ray-agent/blob/master/documents/traffic_relay.md)
- [manual self-build tutorial](https://github.com/chaslui/v2ray-agent/blob/master/documents/Cloudflare_install_manual.md)
...
- [Cloudflare Getting Started Tutorial](https://github.com/chaslui/v2ray-agent/blob/master/documents/cloudflare_init.md)
...
- Support any combination of installation, support for multi-user management, support for DNS streaming media unlock, support for adding multiple ports, [support any door to unlock Netflix](https://github.com/chaslui/v2ray-agent/blob/master/documents/netflix/dokodemo-unblock_netflix.md)
- support to keep tls certificate after uninstall
- support for IPv6, [IPv6 note](https://github.com/chaslui/v2ray-agent/blob/master/documents/ipv6_help.md)
...
- [Support custom certificate installation](https://github.com/chaslui/v2ray-agent/blob/master/documents/install_tls.md)
...
- [CN2 GIA](https://github.com/chaslui/v2ray-agent/blob/master/documents/donation_aff.md#1cn2-gia)
- Shanghai CN2+HK
- [AS9929]( https://github.com/chaslui/v2ray-agent/blob/master/documents/donation_aff.md#2%E8%81%94%E9%80%9A-as9929a%E7%BD%91)
- [AS4837](https://github.com/chaslui/v2ray-agent/blob/master/documents/donation_aff.md#3%E8%81%94%E9%80%9A-as4837%E6%99%AE%E9%80%9A%E6%B0%91%E7%94%A8%E7%BD%91)
- [Unicom Japan Softbank](https://github.com/chaslui/v2ray-agent/blob/master/documents/donation_aff.md#4%E8%81%94%E9%80%9A-%E6%97%A5%E6%9C%AC%E8%BD%AF%E9%93%B6)
- Unicom+ Taiwan TFN
- China Unicom+NTT
...
- **If you use CDN and direct connection at the same time, turn off Yunduo + self-selected IP, refer to the above [Cloudflare optimization plan](https://github.com/chaslui/v2ray-agent/blob/master/documents/optimize_V2Ray.md)**
...
- wget: command not found [**Here you need to do it manually Install wget**]
  , if you have not used Linux, [click to view](https://github.com/chaslui/v2ray-agent/tree/master/documents/install_tools.md) installation tutorial
...
- **[If you don't understand the usage, please check the script usage guide first](https://github.com/chaslui/v2ray-agent/blob/master/documents/how_to_use.md)**
...
- ** The problem that the lower version script cannot be started when upgrading the higher version, [please click this link to view the solution](https://github.com/chaslui/v2ray-agent/blob/master/documents/how_to_use.md#4%E4%BD%8E%E7%89%88%E6%9C%AC%E5%8D%87%E7%BA%A7%E9%AB%98%E7%89%88%E6%9C%AC%E5%90%8E%E6%97%A0%E6%B3%95%E5%90%AF%E5%8A%A8%E6%A0%B8%E5%BF%83)**
...
[You can use my AFF to buy VPS donations - Github](https://github.com/chaslui/v2ray-agent/blob/master/documents/donation_aff.md)

[Support donations to me via virtual currency](https://github.com/chaslui/v2ray-agent/blob/master/documents/donation.md)
...
``` 
wget -P/root -N --no-check-certificate "https://raw.githubusercontent.com/chaslui/v2ray-agent/master/shell/install_en.sh" && mv /root/install_en.sh /root/install.sh && chmod 700 /root/install.sh &&/root/install.sh
``` 


# example image

<img src="https://raw.githubusercontent.com/chaslui/v2ray-agent/master/fodder/install/install.jpg" width=700>
...
[![Stargazers over time](https://starchart.cc/chaslui/v2ray-agent.svg)](https://starchart.cc/chaslui/v2ray-agent)
